...
import 'package:khata_book/Screens/JewarBills/addCreditSaleBillDetails.dart';
...
class particularSaleBill extends StatefulWidget {
  String billId, shopId,billAmount;

  particularSaleBill({this.billId, this.shopId,this.billAmount});
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    children: <Widget>[
                                      ...
                                      Text(
                                        "${left(int.parse(widget.billAmount),int.parse(snapshot.data.documents[index]
                                            .data["creditAmount"]))}",
                                        style: TextStyle(fontSize: 25.0),
                                      ),
                                    ],
