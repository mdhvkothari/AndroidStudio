...
class Universalvariables{
  ...
  static final Color blackColor = Color(0xff9191b);
  static final Color greyColor = Color(0xff8f8f8f);
  static final Color userCircularBackground = Color(0xff2b2b33);
  static final Color onlineDotColor = Color(0xff46dc64);
  static final Color liteBlueColor = Color(0xff0077d7);
  ...
  static final Gradient fadGradient = LinearGradient(
